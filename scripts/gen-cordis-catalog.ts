...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  McpServerSnapshot: 'Host MCP roster read is owned by packages/mcp/mcp-servers/README.md',
  McpServerDraft: 'Host MCP add input is owned by packages/mcp/mcp-servers/README.md',
  McpServerPatch: 'Host MCP update patch is owned by packages/mcp/mcp-servers/README.md',
  McpConnectionTest: 'Host MCP connectivity-test result is owned by packages/mcp/mcp-servers/README.md',
  McpTestTarget: 'Host MCP connectivity-test target is owned by packages/mcp/mcp-servers/README.md',
