...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-mcp': { kind: 'none', reason: 'Browser-side settings surface; the roster it edits is registered by dsh-mcp-servers, and it registers nothing model-facing itself.' },
  ...
  'packages/mcp/mcp-servers': { kind: 'indirect', reason: 'The roster decides which servers mount; dsh-mcp-client owns the mounted tools\' names, schemas, descriptions, and result rendering.' },
