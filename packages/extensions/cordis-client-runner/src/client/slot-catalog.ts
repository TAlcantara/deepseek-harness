...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Authored markdown anywhere in the Chat transcript.',
    doc: 'Authored markdown anywhere in the Chat transcript.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [
      'client-ui-markdown MarkdownSeat',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.chat.markdown\', () => ctx.slots.register(\n      { name: \'conversation.chat.markdown\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-markdown/src/client/contract/slots.ts:138',
  },
  {
    key: 'conversation.chat.markdown.fence',
    kind: 'chain',
    scope: 'session',
    summary: 'Fence and math dispatch for Chat\'s markdown.',
    doc: 'Fence and math dispatch for Chat\'s markdown.',
    registerOptions: [
      {
        name: 'select',
        requirement: 'required',
    ...
    source: 'packages/client/ui-markdown/src/client/contract/slots.ts:140',
  },
  {
  ...
  {
    key: 'conversation.composer.markdown',
    kind: 'single',
    scope: 'session',
    summary: 'Question detail and the plan-review body.',
    doc: 'Question detail and the plan-review body.',
    registerOptions: [],
    ownerProps: [
      '/** Owner currency of one markdown seat. */\nexport interface MarkdownSeatOwnerProps {\n  /** Already-settled or still-streaming markdown source. */\n  text: string\n  /** Whether the source is the tail of a message still being written. */\n  streaming: boolean\n  /** Resolved file mentions for this document; absent where no opener vocabulary exists. */\n  mentions?: MarkdownFileMentions | undefined\n  /** Local-path image vocabulary for this document; absent where no rewriting owner exists. */\n  pathImages?: MarkdownPathImages | undefined\n  /**\n   * Render one fence or math node through the surface\'s fence seat. The\n   * renderer supplies the element it would draw itself — the code arm for a\n   * fence, the authored source for math — and the surface renders that as the\n   * seat\'s fallback, so a declined request keeps the renderer\'s own behavior.\n   * The surface owns this function\'s identity: it must be stable across\n   * renders, because a new identity discards the streaming render cache.\n   * @param request - The fence or math node awaiting a rule.\n   * @param fallback - What the renderer draws when no rule claims the request.\n   * @returns The elected rule\'s element, or the fallback.\n /* …truncated — full shape in source */',
    ],
    ...
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.composer.markdown\', () => ctx.slots.register(\n      { name: \'conversation.composer.markdown\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-markdown/src/client/contract/slots.ts:142',
  },
  {
    key: 'conversation.composer.markdown.fence',
    kind: 'chain',
    scope: 'session',
    summary: 'Fence and math dispatch for the question composer.',
    doc: 'Fence and math dispatch for the question composer.',
    registerOptions: [
      {
        name: 'select',
        requirement: 'required',
    ...
    source: 'packages/client/ui-markdown/src/client/contract/slots.ts:144',
  },
  {
  ...
  {
    key: 'conversation.trajectory.markdown',
    kind: 'single',
    scope: 'session',
    summary: 'Inspected markdown records in the trajectory view.',
    doc: 'Inspected markdown records in the trajectory view.',
    registerOptions: [],
    ownerProps: [
      '/** Owner currency of one markdown seat. */\nexport interface MarkdownSeatOwnerProps {\n  /** Already-settled or still-streaming markdown source. */\n  text: string\n  /** Whether the source is the tail of a message still being written. */\n  streaming: boolean\n  /** Resolved file mentions for this document; absent where no opener vocabulary exists. */\n  mentions?: MarkdownFileMentions | undefined\n  /** Local-path image vocabulary for this document; absent where no rewriting owner exists. */\n  pathImages?: MarkdownPathImages | undefined\n  /**\n   * Render one fence or math node through the surface\'s fence seat. The\n   * renderer supplies the element it would draw itself — the code arm for a\n   * fence, the authored source for math — and the surface renders that as the\n   * seat\'s fallback, so a declined request keeps the renderer\'s own behavior.\n   * The surface owns this function\'s identity: it must be stable across\n   * renders, because a new identity discards the streaming render cache.\n   * @param request - The fence or math node awaiting a rule.\n   * @param fallback - What the renderer draws when no rule claims the request.\n   * @returns The elected rule\'s element, or the fallback.\n /* …truncated — full shape in source */',
    ],
    ...
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.trajectory.markdown\', () => ctx.slots.register(\n      { name: \'conversation.trajectory.markdown\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-markdown/src/client/contract/slots.ts:146',
  },
  {
    key: 'conversation.trajectory.markdown.fence',
    kind: 'chain',
    scope: 'session',
    summary: 'Fence and math dispatch for the trajectory view.',
    doc: 'Fence and math dispatch for the trajectory view.',
    registerOptions: [
      {
        name: 'select',
        requirement: 'required',
    ...
    source: 'packages/client/ui-markdown/src/client/contract/slots.ts:148',
  },
  {
  ...
  {
    key: 'sidebar.right.tab.document.markdown',
    kind: 'single',
    scope: 'session',
    summary: 'A retained markdown document in the right sidebar.',
    doc: 'A retained markdown document in the right sidebar.',
    registerOptions: [],
    ownerProps: [
      '/** Owner currency of one markdown seat. */\nexport interface MarkdownSeatOwnerProps {\n  /** Already-settled or still-streaming markdown source. */\n  text: string\n  /** Whether the source is the tail of a message still being written. */\n  streaming: boolean\n  /** Resolved file mentions for this document; absent where no opener vocabulary exists. */\n  mentions?: MarkdownFileMentions | undefined\n  /** Local-path image vocabulary for this document; absent where no rewriting owner exists. */\n  pathImages?: MarkdownPathImages | undefined\n  /**\n   * Render one fence or math node through the surface\'s fence seat. The\n   * renderer supplies the element it would draw itself — the code arm for a\n   * fence, the authored source for math — and the surface renders that as the\n   * seat\'s fallback, so a declined request keeps the renderer\'s own behavior.\n   * The surface owns this function\'s identity: it must be stable across\n   * renders, because a new identity discards the streaming render cache.\n   * @param request - The fence or math node awaiting a rule.\n   * @param fallback - What the renderer draws when no rule claims the request.\n   * @returns The elected rule\'s element, or the fallback.\n /* …truncated — full shape in source */',
    ],
    ...
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.right.tab.document.markdown\', () => ctx.slots.register(\n      { name: \'sidebar.right.tab.document.markdown\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-markdown/src/client/contract/slots.ts:150',
  },
  {
    key: 'sidebar.right.tab.document.markdown.fence',
    kind: 'chain',
    scope: 'session',
    summary: 'Fence and math dispatch for the document preview.',
    doc: 'Fence and math dispatch for the document preview.',
    registerOptions: [
      {
        name: 'select',
        requirement: 'required',
    ...
    source: 'packages/client/ui-markdown/src/client/contract/slots.ts:152',
  },
  {
