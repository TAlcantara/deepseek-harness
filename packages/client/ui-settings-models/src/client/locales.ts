...
export const en = {
  ...
  compat: 'Wire compatibility',
  compatHint: 'Only for endpoints the adapter does not recognize. Left at the provider default, the adapter decides.',
  compatInherit: 'Provider default',
  compatYes: 'Yes',
  compatNo: 'No',
  compatSupportsStore: 'Send store: false',
  compatSupportsDeveloperRole: 'Developer role for the system prompt',
  compatSupportsReasoningEffort: 'Send reasoning_effort',
  compatSupportsUsageInStreaming: 'Stream token usage',
  compatMaxTokensField: 'Output-cap field',
  compatThinkingFormat: 'Reasoning parameter format',
  compatSupportsMaxOutputTokens: 'Send max_output_tokens',
  compatSupportsStrictMode: 'Strict tool schemas',
  compatSupportsLongCacheRetention: 'Long cache retention',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  removeModel: '删除模型',
  compat: '接口兼容性',
  compatHint: '仅在适配器无法识别该接口时使用；保持“提供方默认”时由适配器自行判断。',
  compatInherit: '提供方默认',
  compatYes: '是',
  compatNo: '否',
  compatSupportsStore: '发送 store: false',
  compatSupportsDeveloperRole: '系统提示使用 developer 角色',
  compatSupportsReasoningEffort: '发送 reasoning_effort',
  compatSupportsUsageInStreaming: '流式返回 token 用量',
  compatMaxTokensField: '输出上限字段名',
  compatThinkingFormat: '推理参数格式',
  compatSupportsMaxOutputTokens: '发送 max_output_tokens',
  compatSupportsStrictMode: '严格工具 Schema',
  compatSupportsLongCacheRetention: '长缓存保留',
