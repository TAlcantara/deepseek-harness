...
/**
 * The fence language this block draws, shown in its banner exactly as a code
 * fence shows its own language: a grammar id, not product copy.
 */
...
export interface MermaidBlockLabels {
  ...
  copiedLabel: string
  /** Accessible name for a fence drawn as a diagram instead of code. */
  diagram: string
}
