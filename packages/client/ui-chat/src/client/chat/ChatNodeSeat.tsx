...
export const ChatNodeSeat = memo(function ChatNodeSeat({
  ...
  loadImage, renderMessageImages, renderMarkdown, fileMentions, useStore, actions, renderSlot, t,
}: ChatNodeSeatProps) {
  ...
  const owner = useMemo<ChatNodeOwnerProps | null>(() => node === undefined
    ...
    loadImage, renderMessageImages, renderMarkdown, fileMentions, turnProcess,
  ])
