 ...
 * ui-settings-models, ui-settings-mcp, ui-settings-plugins, and
 * ui-agent-preset. A plugin adding a section changes this list.
 */
const PRODUCT_SECTIONS: readonly string[] = ['general', 'models', 'mcp', 'plugins', 'agent-presets']
