...
| [`ui-markdown/`](ui-markdown/README.md) | Renders authored markdown and dispatches fences to pluggable rules | — |
| [`ui-markdown-rules/`](ui-markdown-rules/README.md) | Registers the built-in markdown fence rules (TeX math, Mermaid) into every surface's fence seat | — |
