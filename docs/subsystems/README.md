...
| [mcp.md](mcp.md) | the settings-backed MCP server roster: `McpServerSnapshot`/`Draft`/`Patch`, the `ctx.mcpServers` Remote methods, connectivity testing, mounting and naming |
